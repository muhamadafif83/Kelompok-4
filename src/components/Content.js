  ...
  const Navigate = useNavigate()
    ...
    <div className="h-screen w-5/6 flex flex-col justify-center items-center bg-[#0F2443]">
      ...
      <div className="grid grid-cols-3 md:grid-cols-3 gap-4 "  >
        <button onClick={() => Navigate('/bindo')} className="bg-[#66738F] hover:bg-[#9599B2] text-white font-bold py-4 px-6 rounded w-full  text-left h-24 text-xl"><img src="https://i.pinimg.com/originals/02/c6/e9/02c6e93549ae84f21ee5b1868f017503.jpg" alt="icon" className="inline-block h-5 w-5 mr-2" />Bahasa Indonesia<div className="text-xs pl-9 text-white font-mono">6 Tugas</div></button>
        <button onClick={() => Navigate('/')} className="bg-[#66738F] hover:bg-[#9599B2] text-white font-bold py-4 px-6 rounded w-full  text-left h-24 text-xl"><img src="https://i.pinimg.com/originals/02/c6/e9/02c6e93549ae84f21ee5b1868f017503.jpg" alt="icon" className="inline-block h-5 w-5 mr-2" /> Matematika<div className="text-xs pl-9 text-white font-mono">6 Tugas</div></button>
