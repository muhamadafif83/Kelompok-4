...
const Mtk = () => {
    ...
    <div className="h-screen w-5/6 flex flex-col justify-center items-start bg-[#0F2443]">
      ...
      <div className="grid grid-cols-3 md:grid-cols-2 gap-4 "  >
        <button onClick={() => Btn('#/')} className="bg-[#66738F] hover:bg-[#9599B2] text-white font-bold py-6 px-60 pl-14 rounded w-full border border-white hover:border-green-500  text-start h-24 text-xl"><span className="hover:text-green-400">Tugas 1</span><div className="text-xs  text-white hover:text-red-500 font-mono">Batas Pengumoulan: 10/02/1999 23:59:59</div></button>
        <button onClick={() => Btn('#/')} className="bg-[#66738F] hover:bg-[#9599B2] text-white font-bold py-4 px-60 pl-14 rounded w-full border border-white hover:border-green-500  text-start h-24 text-xl"><span className="hover:text-green-400">Tugas 2</span><div className="text-xs  text-white hover:text-red-500 font-mono">Batas Pengumoulan: 10/02/1999 23:59:59</div></button>
        <button onClick={() => Btn('#/')} className="bg-[#66738F] hover:bg-[#9599B2] text-white font-bold py-4 px-60 pl-14 rounded w-full border border-white hover:border-green-500  text-start h-24 text-xl"><span className="hover:text-green-400">Tugas 3</span><div className="text-xs  text-white hover:text-red-500 font-mono">Batas Pengumoulan: 10/02/1999 23:59:59</div></button>
        <button onClick={() => Btn('#/')} className="bg-[#66738F] hover:bg-[#9599B2] text-white font-bold py-4 px-60 pl-14 rounded w-full border border-white hover:border-green-500  text-start h-24 text-xl"><span className="hover:text-green-400">Tugas 4</span><div className="text-xs  text-white hover:text-red-500 font-mono">Batas Pengumoulan: 10/02/1999 23:59:59</div></button>
      </div>
      <br/>
      <button onClick={() => Btn('/tugas')} className="bg-red-700 hover:bg-green-500 text-white hover:text-black rounded px-3">Back</button>
    </div>
