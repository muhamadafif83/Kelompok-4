...
const PMobile = () => {
    ...
    <div className="h-screen w-5/6 flex flex-col justify-center items-start bg-[#0F2443]">
      ...
      <br/>
      <button onClick={() => MB('/tugas')} className="bg-red-700 hover:bg-green-500 text-white hover:text-black rounded px-3">Back</button>
    </div>
